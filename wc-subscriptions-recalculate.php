 ...
 * Version: 1.0.1
 * Description: Bulk update existing WooCommerce Subscriptions when the prices of products change, via a WP-CLI command (`wcsr recalculate`).
 * Author: ara303 
    ...
    public function recalculate() {
        ...
        foreach( $subscriptions as $subscription_post ){
            ...
            foreach( $subscription->get_items() as $item_id => $item ){
                ...
                WP_CLI::log( "Updated price for subscription ID {$subscription_post->ID} to {$new_price} (was {$old_price})." );
            }
        ...
        WP_CLI::success( "All subscriptions recalculated." );
    }
}
